...
export default function Footer() {
  return (
    <footer className="container">
      <div>
        <hr className="md:mt-8 mt-10 border-neutral-500 max-[1105px]:mb-0 md:mt-0" />
        <div className="flex align-center justify-between md:py-2 py-4">
          <div className="flex md:items-center md:flex-row flex-col md:gap-6 gap-4">
            ...
            <div className="text-neutral-400 text-xs flex items-center">
              ...
              <span className="hidden md:block mx-2 bg-[#AAA] w-[1px] h-2" />
              <a href="#">Cookies Policy</a>
              <span className="hidden md:block mx-2 bg-[#AAA] w-[1px] h-2" />
              <a href="#">Terms of Service</a>
            </div>
            <p className="flex md:hidden items-center mb-0 text-[10px] text-neutral-400">powered by <Image src="/google-icon.svg" alt="Google Icon" width={80} height={11.3} className="ms-1" /></p>
          </div>
          <div className="hidden md:block">
            <p className="flex items-center mb-0 text-[10px] text-neutral-400">powered by <Image src="/google-icon.svg" alt="Google Icon" width={80} height={11.3} className="ms-1" /></p>
          </div>
        </div>
        <hr className="hidden md:block mt-8 border-neutral-500 max-[1105px]:mb-0 md:mt-0" />
        <div className="flex flex-col md:flex-row md:items-center justify-between md:py-2 md:mb-4 mb-10">
