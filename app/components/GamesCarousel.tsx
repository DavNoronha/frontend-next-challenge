...
export default function GamesCarousel() {
  ...
  return (
    <div className="relative max-[768px]:w-full max-[768px]:overflow-hidden">
          ...
          >
            ...
            <div className="w-full px-2 min-h-[96px] desc">
              <div className="flex items-center gap-2 py-1 min-h-[36px]">
                <Image src="/steam.svg" alt="Steam Logo" width={16} height={16} />
                <Image src="/tree.svg" alt="Donate Logo" width={16} height={16} />
      ...
      <div className="md:flex hidden absolute top-0 right-0 bg-black/80 w-20 min-h-[272px] carousel-gradient-bg z-10 cursor-pointer" />
      <button className="md:flex hidden absolute top-1/2 -translate-y-1/2 -right-[20px] bg-[#00CC7E] flex items-center flex-grow justify-center font-medium purchase-btn w-10 h-10 z-20 cursor-pointer">
        <Image src="/chevron-right-outline.svg" alt="Right Arrow" width={16} height={13.3} />
      </button>
    </div>
  )
}